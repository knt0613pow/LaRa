...
if __name__ == '__main__':
    ...
    cfg.train_dataset.data_root = "dataset/gobjaverse/gobjaverse_part_01.h5"
    cfg.test_dataset.data_root = "dataset/gobjaverse/gobjaverse_part_01.h5"
    cfg.model.ckpt_path = "ckpt/epoch=29.ckpt"
    cfg.train.n_epoch = 31
    cfg.gpu_id = [0]
